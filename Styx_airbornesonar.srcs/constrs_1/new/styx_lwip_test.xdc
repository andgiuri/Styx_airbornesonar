...
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST} [get_ports MDIO_PHY_0_mdc]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST} [get_ports MDIO_PHY_0_mdio_io]
...
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST} [get_ports Res_0]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST DRIVE 24} [get_ports {RGMII_0_td[0]}]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST DRIVE 24} [get_ports {RGMII_0_td[1]}]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST DRIVE 24} [get_ports {RGMII_0_td[2]}]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST DRIVE 24} [get_ports {RGMII_0_td[3]}]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST DRIVE 24} [get_ports RGMII_0_tx_ctl]
set_property -dict {IOSTANDARD LVCMOS18 SLEW FAST} [get_ports RGMII_0_txc]
