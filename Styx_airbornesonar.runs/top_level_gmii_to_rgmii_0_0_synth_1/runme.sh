...
HD_PWD='/home/user/Desktop/Styx_airbornesonar/Styx_airbornesonar.runs/top_level_gmii_to_rgmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_gmii_to_rgmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_gmii_to_rgmii_0_0.tcl
